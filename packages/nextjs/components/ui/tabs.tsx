...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={clsx("inline-flex items-center justify-center bg-stone-500 p-1 text-stone-100", className)}
    {...props}
  />
));
